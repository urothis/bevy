...
pub mod prelude {
    ...
    pub use crate::{
        ...
        Camera, Camera2d, Camera3d, CameraMainPassTextureFormat, ClearColor, ClearColorConfig,
        CompositingSpace, DepthStencilFormat, MsaaWriteback, OrthographicProjection,
        PerspectiveProjection, Projection, StencilTest,
    };
}
